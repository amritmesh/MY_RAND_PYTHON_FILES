...
for movies in range(5):
    ...
    movie_list[movies] = movie_choices
print(movie_list)
...
for movies in range(5):
    ...
    movie_list[movies] = movie_choices
print(movie_list)
watch_movie = input("""Please enter the name of the movie that you
want to watch (from the list): """)
if watch_movie in movie_list:
...
# Question 7
movie_list = [None] * 5
director_list = [None] * 5
for movies in range(5):
    movie_choices = input("Please enter a movie: ")
    directors_of_movies = input("Please enter the director of this movie: ")
    movie_list[movies] = movie_choices
    director_list[movies] = directors_of_movies
print("Movie list:", movie_list)
print("Director list:", director_list)
movie_choice = int(input("""Enter the number of the movie that you want to see
the details of (0 through 4 from left to right in the list): """))
print("Movie name:", movie_list[movie_choice])
print("Director name:", director_list[movie_choice])
...
if watch_movie in movie_list:
    movie_index = movie_list.index(watch_movie)
    print("The director of this film is:", director_list[movie_index])
else:
